// TUI streaming — character-by-character like a real LLM session. Replays
// the [data-line] children of each [data-tui-stream] container, with an
// internal scroll pinned to the bottom while text grows.
...
async function runTuiStream(root: Element): Promise<void> {
  ...
  // rAF-batched scroll to avoid layout thrash during fast char appends.
