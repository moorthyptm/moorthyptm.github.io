// HTML renderers for the agent's JSON payloads. Escape-then-emit; URLs go
// through the same ALLOWED_DOMAINS whitelist as the chat widget. Types come
// from build-schemas.ts so the schema is the single source of truth.
